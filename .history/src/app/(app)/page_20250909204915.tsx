      ...
      <main className="flex-grow flex flex-col items-center justify-center px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <section className="mb-16 animate-fade-in">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-purple-900 mb-6 leading-tight animate-slide-up">
              Anonymous
              <span className="block text-purple-600">Messaging</span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-purple-600 max-w-2xl mx-auto leading-relaxed animate-slide-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="w-full max-w-2xl mx-auto">
            <h2 className="text-xl sm:text-2xl font-semibold text-purple-900 mb-8">Recent Messages</h2>
            <Carousel
